...
export const cursosMock: Curso[] = [
  ...
  },
  {
    id: "sql-server",
    titulo: "SQL Server",
    descricao: "Consultas SQL, modelação, procedures, views e administração básica no SQL Server.",
    ...
    conteudoDetalhado: "Do básico ao uso de objetos de bases de dados e otimizações.",
    avaliacoes: 38,
    alunos: 510,
    criado_em: new Date().toISOString(),
    aulas: 35,
