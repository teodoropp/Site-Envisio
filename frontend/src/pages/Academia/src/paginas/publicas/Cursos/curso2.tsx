...
export default function CursoDetalhe() {
  ...
  const listaDepoimentos = [
    {
      ...
      texto:
        "O curso de Programação Web é incrível! Aprendi React e Tailwind do zero e consegui criar a minha primeira aplicação web completa.",
      estrelas: 5,
    },
    {
      id: 2,
      autor: "Beatriz Sousa",
      cargo: "Designer UI/UX & Web Developer",
      texto:
        "A didática do formador é fantástica. A construção de projetos reais durante o curso deu-me a confiança necessária para trabalhar com clientes reais.",
      estrelas: 5,
    },
    {
      id: 3,
      ...
      texto:
        "Superou todas as expectativas! Os módulos de Git, JavaScript moderno e desenvolvimento responsivo são fundamentais no mercado atual.",
      estrelas: 5,
    },
  ];
  ...
  const cursoLocal: Curso = {
    ...
    descricao:
      "HTML, CSS, JavaScript moderno e React. Crie interfaces modernas e responsivas com boas práticas do mercado.",
    categoria: "Programação Web",
    duracao: 12,
    nivel: "intermediario",
    imagemUrl: "/academia/frontend.jpg",
    requisitos: [
      "Noções básicas de utilização de computador e internet",
      "Vontade de aprender lógica e código",
    ],
  } as Curso;
  ...
  const modulosDefinidosAqui: Modulo[] = [
    {
      id: "m2-1",
      titulo: "Módulo 1: Introdução à Programação Web",
      duracaoTotal: "",
      ordem: 1,
      aulas: [
        {
        ...
        {
          id: "m2-1-a2",
          titulo: "O mercado web em Angola e no mundo",
          tipo: "texto",
          duracao: "",
        },
        {
          id: "m2-1-a3",
          titulo: "Ferramentas essenciais do programador",
          tipo: "texto",
          duracao: "",
        },
      ],
    ...
    {
      id: "m2-2",
      titulo: "Módulo 2: HTML5 - Estruturação de Páginas",
      duracaoTotal: "",
      ordem: 2,
      aulas: [
        {
          id: "m2-2-a1",
          titulo: "Tags semânticas e estrutura base",
          tipo: "texto",
          duracao: "",
        },
        {
          id: "m2-2-a2",
          titulo: "Formulários, tabelas e mídias",
          tipo: "texto",
          duracao: "",
        },
      ],
    ...
    {
      id: "m2-3",
      titulo: "Módulo 3: CSS3 - Estilização Avançada & Layouts",
      duracaoTotal: "",
      ordem: 3,
      aulas: [
        {
          id: "m2-3-a1",
          titulo: "Box Model, Flexbox e CSS Grid",
          tipo: "texto",
          duracao: "",
        },
        {
          id: "m2-3-a2",
          titulo: "Design Responsivo & Media Queries",
          tipo: "texto",
          duracao: "",
        },
      ],
    ...
    {
      id: "m2-4",
      titulo: "Módulo 4: JavaScript Moderno (ES6+)",
      duracaoTotal: "",
      ordem: 4,
      aulas: [
        {
          id: "m2-4-a1",
          titulo: "Lógica, Funções, DOM e Eventos",
          tipo: "texto",
          duracao: "",
        },
        {
          id: "m2-4-a2",
          titulo: "Consumo de APIs REST com Fetch/Axios",
          tipo: "texto",
          duracao: "",
        },
      ],
    ...
    {
      id: "m2-5",
      titulo: "Módulo 5: React.js & Frameworks Modernos",
      duracaoTotal: "",
      ordem: 5,
      aulas: [
        {
          id: "m2-5-a1",
          titulo: "Componentes, Props e Hooks (useState, useEffect)",
          tipo: "texto",
          duracao: "",
        },
        {
          id: "m2-5-a2",
          titulo: "Projeto Final Frontend Completo",
          tipo: "texto",
          duracao: "",
        },
      ],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-12 text-left">
              <span className="inline-block px-3 py-1 mb-4 text-[10px] font-extrabold uppercase tracking-wider text-red-600 bg-red-50 border border-red-100 rounded-[4px]">
          ...
          <div className="lg:col-span-4 relative z-30 space-y-6">
            <div className="bg-white rounded-[5px] p-6 border border-slate-200/80 shadow-sm">
              ...
              <div className="flex items-start gap-4">
                <img
                  src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=250&q=80"
                  alt="Eng. Fernando Costa"
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed mb-3 line-clamp-2">
                    Com mais de 10 anos de experiência no desenvolvimento de
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-xs text-slate-600 mb-6">
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong>80 Horas</strong> de formação prática
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
      ...
      <section className="bg-slate-100/70 py-16 border-t border-slate-200/80 text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <button
              onClick={() => navigate("/academia/cursos")}
              className="btn-academia-secondary inline-flex items-center justify-center px-5 py-2.5 text-xs uppercase tracking-wider cursor-pointer">
          ...
          <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 items-stretch min-h-[440px]">
              <div className="md:col-span-5 h-64 md:h-auto w-full relative">
                <img
                  src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                  alt="Eng. Fernando Costa"
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-center text-left max-h-[500px] overflow-y-auto">
                ...
                <div className="mb-5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
                    Licenciado em Engenharia Informática - Universidade
                    Agostinho Neto
                  </p>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
                    Especialista com vasta experiência na criação de sistemas
                    web corporativos, guias de estilo e arquiteturas frontend em
                    React e TypeScript.
                  </p>
                </div>
