...
export default function CursoDetalhe() {
  ...
  const listaDepoimentos = [
    {
      ...
      cargo: "Administradora de Dados (DBA)",
      texto:
        "O curso de SQL Server é excelente! Aprendi a otimizar queries complexas e administrar backups corporativos com total segurança.",
      estrelas: 5,
    },
    {
      id: 2,
      ...
      texto:
        "Didática espetacular. Os exercícios práticos de modelagem relacional e stored procedures transformaram a minha produtividade no trabalho.",
      estrelas: 5,
    },
    {
      id: 3,
      ...
      texto:
        "Dominar T-SQL e indexação foi um divisor de águas na minha carreira. Recomendo vivamente a todos os profissionais de IT.",
      estrelas: 5,
    },
  ];
  ...
  const cursoLocal: Curso = {
    id: "sql-server-base-dados",
    titulo: "Gestão de Base de Dados SQL Server",
    descricao:
      "Aprenda a administrar, otimizar e programar bases de dados relacionais com Microsoft SQL Server e T-SQL.",
    categoria: "Base de Dados & BI",
    duracao: 12,
    nivel: "intermediario",
    imagemUrl: "/academia/sql.svg",
    requisitos: [
      "Noções básicas de lógica de dados ou folhas de cálculo (Excel)",
      "Vontade de trabalhar com dados corporativos",
    ],
  } as Curso;
  ...
  const modulosDefinidosAqui: Modulo[] = [
    {
      id: "m4-1",
      titulo: "Módulo 1: Introdução a Bancos de Dados Relacionais",
      duracaoTotal: "",
      ordem: 1,
      aulas: [
        {
    ...
    {
      id: "m4-2",
      titulo: "Módulo 2: Linguagem DDL & DML (T-SQL)",
      duracaoTotal: "",
      ordem: 2,
      aulas: [
        {
    ...
    {
      id: "m4-3",
      titulo: "Módulo 3: Consultas Avançadas & Joins",
      duracaoTotal: "",
      ordem: 3,
      aulas: [
        {
    ...
    {
      id: "m4-4",
      titulo: "Módulo 4: Programação SQL, Stored Procedures & Backup",
      duracaoTotal: "",
      ordem: 4,
      aulas: [
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-12 text-left">
              <span className="inline-block px-3 py-1 mb-4 text-[10px] font-extrabold uppercase tracking-wider text-purple-400 bg-purple-500/10 border border-purple-500/20 rounded-[4px]">
          ...
          <div className="lg:col-span-4 relative z-30 space-y-6">
            <div className="bg-white rounded-[5px] p-6 border border-slate-200/80 shadow-sm">
              ...
              <div className="flex items-start gap-4">
                <img
                  src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=250&q=80"
                  alt="Dra. Maria Mendes"
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-purple-600 hover:text-purple-700 hover:underline transition-colors">
                    <span>Ver mais sobre a formadora</span>
      ...
      <section className="bg-slate-100/70 py-16 border-t border-slate-200/80 text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 flex flex-col items-center">
            <span className="inline-block px-3 py-1 mb-2 text-[10px] font-extrabold uppercase tracking-wider text-purple-600 bg-purple-50 border border-purple-100 rounded-[4px]">
              Evolução Contínua
            </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div
              ...
              <div className="p-4 flex flex-col flex-1 bg-white">
                ...
                <h3 className="font-bold text-sm text-slate-900 group-hover:text-blue-600 transition-colors mb-1.5 line-clamp-1">
          ...
          <div className="text-center mt-8">
            <button
              onClick={() => navigate("/academia/cursos")}
              className="inline-flex items-center justify-center px-5 py-2.5 bg-slate-900 hover:bg-purple-600 text-white font-bold text-xs uppercase tracking-wider rounded-[5px] transition-all shadow-sm cursor-pointer">
          ...
          <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 items-stretch min-h-[440px]">
              ...
              <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-center text-left max-h-[500px] overflow-y-auto">
                ...
                <p className="text-xs font-bold text-purple-600 uppercase tracking-wide mb-6">
                  CEO & ARQUITETA DE DADOS
                </p>
                ...
                <div className="mb-5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
                    Mestre em Engenharia de Software & Sistemas de Informação
                  </p>
                </div>
